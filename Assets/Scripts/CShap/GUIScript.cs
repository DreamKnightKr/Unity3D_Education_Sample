	...
	public class GUIScript : MonoBehaviour
	{
			...
			void OnGUI ()
			{
	            ...
	            GameObject.Instantiate( objTextHello_Android );
					...
					// Load From Resource
					nYPosCount++;
					if (GUI.Button (new Rect (fPosX, fPosY + (fYInterval * nYPosCount), 200, 30), "(1)Show Resources")) {
					...
					nYPosCount++;
					if (GUI.Button (new Rect (fPosX, fPosY + (fYInterval * nYPosCount), 200, 30), "(2)Show StreamingAssets")) {
						if (null == txt)
